    ...
    public <T> T dispatch() throws APIResponseException {
        ...
        try {
            ...
            if (isDefaultResponse)
                ...
                throw APIResponseException.APIResponseBuilder(response, null).build();
        } catch (JsonMappingException e) {
            throw APIResponseException.APIResponseBuilder(response, e).build();
        } catch (IOException | InterruptedException e) {
            throw RestClientHelper.getUnableToConnectException(e);
        }
    }
